...
def getPuuid(Region,summonerName,tagline):
    puuid = requests.get("https://" + Region + ".api.riotgames.com/riot/account/v1/accounts/by-riot-id/" + summonerName + "/" + tagline + "?api_key=" + API)
...
def getMatches(region,Summoner,MatchIDs,SummonerInfo,RankedDetails,mastery):
    ...
    for matchID in MatchIDs:
        ...
        RankId = getRankId(RankedDetails)
        ...
        matchIdsData['Rank'].append(getRankId(RankedDetails))
